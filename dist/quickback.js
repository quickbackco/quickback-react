...
var Quickback = function Quickback(_ref) {
  var url = _ref.url;
  var _useState = (0, _react.useState)(false),
    _useState2 = _slicedToArray(_useState, 2),
    quicking = _useState2[0],
    setQuicking = _useState2[1];
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              setQuicking(true);
              quickback_text = textareaRef.current.value;
              _context.next = 5;
  ...
  return /*#__PURE__*/_react.default.createElement("form", {
    ...
    id: "quickback-wrapper-id-system",
    className: "absolute bottom-8 right-8 flex flex-col rounded-lg border bg-white dark:bg-zinc-800"
  }, /*#__PURE__*/_react.default.createElement("textarea", {
    ref: textareaRef,
    name: "feedly_text",
    placeholder: "Quickback ?",
    rows: "3",
    minLength: "3",
    className: "quick-area peer h-12 w-64 resize-none border-0 bg-transparent p-2 text-sm transition-all duration-100 placeholder-shown:h-9 placeholder-shown:w-24 focus:h-12 focus:w-64 focus:outline-none dark:text-white"
